...
//=============
{
   ...
   public static native void SHIFT(int width, int height, ByteBuffer image1, ByteBuffer image2, int[] result);

   public static native boolean KLUDGE(int width, int height, ByteBuffer image, int shift, boolean isRight,
                                       ByteBuffer imageOut);
